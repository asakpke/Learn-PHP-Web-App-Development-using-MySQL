...
if (!empty($_GET)) {
	...
	if ($row == null) {
		...
		// exit;
		// die('<h1>Invalid email/password.</h1>');
...
<html lang="en" data-bs-theme="auto">
  <head>
		<script src="bootstrap-5.3.1-examples/assets/js/color-modes.js"></script>
    <meta charset="utf-8">
...
<link href="../Class 3/bootstrap-5.3.1-dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="../Class 3/bootstrap-5.3.1-examples/sign-in/sign-in.css" rel="stylesheet">
  </head>
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
      ...
      <form action="4.php">
        ...
        <div class="form-check text-start my-3">
          ...
          <label class="form-check-label" for="flexCheckDefault">
            Remember me [implement it later]
          </label>
        </div>
    ...
    <script src="../Class 3/bootstrap-5.3.1-dist/js/bootstrap.bundle.min.js"></script>

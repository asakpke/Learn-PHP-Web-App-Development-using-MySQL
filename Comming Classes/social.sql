...
--
-- Host: localhost
-- Generation Time: Oct 19, 2023 at 08:29 AM
...
--
ALTER TABLE `shares`
  ADD CONSTRAINT `posts_shares` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
